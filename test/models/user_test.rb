...
class UserTest < ActiveSupport::TestCase
	...
	test 'places_visited_returns_start_location' do
		user = User.new(first_name: 'test', last_name: 'tester', email: 'testmail@test.com', password: '123', password_confirmation: '123', match: true)
		user.save
