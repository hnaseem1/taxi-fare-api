class ApplicationController < ActionController::Base
  ...
  def get_data(start_lat,start_long,end_lat,end_long)
  ...
  # Checks for the if the user trying something is authorized
  def current_user
  	if session[:user_id]
  ...
  # If user is already logged in he will be redirected to user index page
  ...
  # To make sure if the someone is has to login to perform specific action
